...
if [ -e '/usr/bin/wget' ]; then
    ...
    wget --no-check-certificate https://raw.githubusercontent.com/ifaist0s/phpmyadmin-fixer/master/create_tables.sql;
    else
...
if [ -e '/usr/bin/curl' ]; then
    ...
    curl -O -k https://raw.githubusercontent.com/ifaist0s/phpmyadmin-fixer/master/create_tables.sql;
    else
